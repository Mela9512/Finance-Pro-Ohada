...
export class UpdateCompanyDto {
  ...
  @IsOptional() @IsNumber() @Type(() => Number) capital?: number;
  ...
  @IsOptional() @IsNumber() @Type(() => Number) fiscalYear?: number;
  @IsOptional() @IsNumber() @Type(() => Number) accountLength?: number;
  @IsOptional() @IsNumber() @Type(() => Number) decimals?: number;

  // ─── Fiscalité ────────────────────────────────────────────────────────────
  @IsOptional() @IsString() taxRegime?: string;
  @IsOptional() @IsString() taxCenter?: string;
  @IsOptional() @IsString() taxNumber?: string;
  @IsOptional() @IsBoolean() vatEnabled?: boolean;
  @IsOptional() @IsNumber() @Type(() => Number) vatRate?: number;
  @IsOptional() @IsBoolean() withholdingTax?: boolean;
  @IsOptional() @IsBoolean() corporateTax?: boolean;

  // ─── Banque & Trésorerie ──────────────────────────────────────────────────
  @IsOptional() @IsString() bankName?: string;
  @IsOptional() @IsString() bankAccount?: string;
  @IsOptional() @IsString() bankCode?: string;
  @IsOptional() @IsString() cashName?: string;
  @IsOptional() @IsArray() @IsString({ each: true }) paymentMethods?: string[];
  @IsOptional() @IsString() bankCurrency?: string;
  ...
  @IsOptional() @IsArray() @IsString({ each: true }) costCenters?: string[];
  @IsOptional() @IsArray() @IsString({ each: true }) profitCenters?: string[];
